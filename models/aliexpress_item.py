...
class AliexpressItem():
    ...
    def __init__(
        ...
        specs: list = None, average_star: float = None, 
        trade_count: int = None, product_id: str = None, url: str = None, delivery_price: int = None,
        delivery_date = None, thumbnail_url: str = None, sku_property_json: str = None,
        discount_rate: float = None, favorite_count: int = None
        ):
        self.name = name
